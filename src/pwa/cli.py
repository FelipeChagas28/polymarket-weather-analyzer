...
# Paper-trading tests run in parallel; default is to execute all seven in sequence
...
def paper_run(
    ...
    """Roda uma sessão diária. Sem --db/--mode roda os 7 paper-trading tests em sequência."""
    valid_modes = (
        "auto", "strict", "strongbuy",
        "strongbuy_priceband", "strongbuy_minpayoff", "strongbuy_evstrict",
        "flat_tiered", "strongbuy_cities",
